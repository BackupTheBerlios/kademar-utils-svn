...
class editor(QDialog):
    ...
    def accept(self):
        self.datos_final=[self.Codigo, self.Categoria, self.Nombre_es, self.Nombre_es,self.Nombre_ca, self.Descripcion_en, self.Descripcion_es,self.Descripcion_ca, self.Ejecutable, self.Icono, self.Categorias]
